...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Mess Manager Pro" },
      { name: "author", content: "Mess Manager Pro" },
      ...
      { name: "twitter:title", content: "Mess Manager Pro — Shared mess expenses, settled fairly" },
